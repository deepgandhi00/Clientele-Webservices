...
@NamedQueries({
    ...
    @NamedQuery(name = "Route.findByAddId", query = "SELECT r FROM Route r WHERE r.addId = :addId"),
...
public class Route implements Serializable {
    ...
    public Route(Integer routeId, int addId, String routeName) {
        this.routeId = routeId;
        this.addId = addId;
    ...
    public String toString() {
        return "clientele.Route[ routeId=" + routeId + " ]";
    }
